...
public class Ex04_switch {
	...
	public static void main(String[] args) {
		...
		// case 값: 실행문; break;
		// case 값: 실행문; break;
		// case 값: 실행문; break; // break의 뜻은 'switch 실행문을 종료합니다' 라는 의미이다.
		// default: 실행문; // default는 통상 break를 쓰지 않는다.
		// }
		
		// switch가 가진 장점은 if와 비교했을때 보기 좋다.
		...
		System.out.println(floor + "층 관리자는 " + manager + "매니저 입니다.");
